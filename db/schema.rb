...
ActiveRecord::Schema.define(version: 2019_09_25_073951) do
  ...
  create_table "magic_cards", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["multiverse_ids"], name: "index_magic_cards_on_multiverse_ids"
    t.index ["name"], name: "index_magic_cards_on_name"
    t.index ["scryfall_id"], name: "index_magic_cards_on_scryfall_id"
  end
